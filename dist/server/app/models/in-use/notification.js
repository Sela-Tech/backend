...
var notificationStructure = {
  project: {
    ...
    ref: "Project",
    autopopulate: {
      select: "name activated _id owner "
    }
  },
  user: {
    type: ObjectId,
  ...
  stakeholder: {
    ...
    ref: "User",
    autopopulate: {
      select: "firstName lastName _id organization profilePhoto"
    }
  },
  message: {
    type: String,
  ...
  type: {
    type: String,
    enum: ["REQUEST_TO_JOIN_PROJECT", "ACCEPT_INVITE_TO_JOIN_PROJECT", "PROPOSAL_APPROVED", "PROPOSAL_REVERTED", "PROPOSAL_REJECTED", "REJECT_INVITE_TO_JOIN_PROJECT", "INVITATION_TO_JOIN_PROJECT", "YOU_SENT_INVITATION_TO_JOIN", "NEW_PROPOSAL", "PROPOSAL_ASSIGNED"]
  },
  read: {
    type: Boolean,
    default: false

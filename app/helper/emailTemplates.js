...
<body>
            ...
            <tr style='background: #FAFAFA;'>
                ...
                '>
                       <img 
                        ...
                        color: #222829;
                        font-weight: 500;
                        "> Hello, ${contractor.firstName} </p>
                      
                      <div class="img-container">
                        <img src=${project.owner.profilePhoto || "http://placehold.it/50"} alt='50'/>
                      </div>
                      <p  class='text'> <strong>${project.owner.firstName} ${project.owner.lastName}</strong> assigned you to a proposal for project, <strong>${project.name}</strong></p>
    ...
    messageOnfailedDonation: (amount, name, project) => {
        return `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
                ...
                <tr style='background: #FAFAFA;'>
                    ...
                    '>
                           <img 
                            ...
                            margin: 25px 0;
                            color: #222829;
                            ">Your attempt to sponsor the <strong>${project}</strong> project with ${amount} was not successful.</p>
                    </td>
                </tr>
